...
import 'package:flutter_persistent_login/features/login/cubit/login_controller.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  final loginCubit = getDependency<LoginController>();
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          body: ListenableBuilder(
              listenable: loginCubit,
              builder: (context, child) {
                return loginCubit.isLoading
                    ? Center(
